...
<body>
    ...
    <nav class="navbar navbar-default" data-spy="affix" data-offset-top="60">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <div class="m">
                   <font color="white"> <h4>This bridge is for all type of vehicle</h4></font>
                </div>
            </div>
        ...
        <!--</div>
        <!-- /.container-fluid -->
		<!--echo"<right><b><br><font color='sky blue'><h4>This bridge is for all type of vehicle</font></h4></b> </right></br>";-->
		<div class="search">
	    <ul>
		    <li><div class="slot">
	<form action="Total_amount.php" method="post">
   ...
   <input type="submit" value="Login">
			...
			<li><div class="slot1">
	<form action="Bike Search insertno.php" method="post">
	 
    <p>
   <color:blue><b> Vehicle type</b><br>
	car<br>
	bus<br>
	track<br>
	bike<br>
                        ...
                        <div class="col-md-7">
                            <div class="banner-text-content">
                                ...
                                <div class="button-group">
                                    <!--<a class="btn btn-lg" href="">Sign Up</a>-->

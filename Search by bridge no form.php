    ...
    <nav class="navbar navbar-default" data-spy="affix" data-offset-top="60">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <div class="m">
                   <font color="white"> <h4>Search in Bridge No</h4></font>
                </div>
            </div>
	    ...
	    <ul>
		    <li><div class="slot">
	<form action="search by bridge no insert.php" method="post">
	 
    <p>
        <label for="Bridge_no">Bridge No</label>
        <input type="text" name="Bridge_no" id="Bridge_no">
    </p>

    ...
    <nav class="navbar navbar-default" data-spy="affix" data-offset-top="60">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <div class="m">
                   <font color="white"> <h4>Current price = <?php
...
$result1 = mysqli_query($con,"SELECT * FROM bridge_1");
$Vehicle_type = mysqli_real_escape_string($con, $_REQUEST['Vehicle_type']);
...
?>TK</h4></font>
            ...
            <!--<div class="collapse navbar-collapse" id="navbar-collapse">
				...
				<div class="mainmenu">
				<ul>
				    <li><a href="Refill form.php">Refill</a></li>
...
$Vehicle_no = mysqli_real_escape_string($con, $_REQUEST['Vehicle_no']);
$result = mysqli_query($con,"SELECT * FROM bridge_1 WHERE Vehicle_no='$Vehicle_no'");



            
			//$sql = "UPDATE bridge_1 SET Total_amntt='$Total_amnt' WHERE  Vehicle_no='$Vehicle_no'";
echo "<table id='t01' border='5' cellpadding=''align='center'background-color='white'>";
		...
		<th><font color='white' align='center'>Vehicle_type</font></th>
		<th><font color='white' align='center'>Due </font></th>
		<th><font color='white' align='center'>Deposit_amount<font></th>
		<th><font color='white' align='center'>Total Amount<font></th>
        <th><font color='white' align='center'>Date<font></th>";		

//echo"<center><b><font color='sky blue'><h4>Vehicle info</font></h4></b> </center>";


	echo"<center><b><br><br><font color='sky blue'><h4>Vehicle information</font></h4></b> </center></br></br>";
...
while($row = mysqli_fetch_array($result)) 
	{
		...
		echo "<tr>"; 
				...
				echo '<td style="color:blue" align="center";>' . $row['Vehicle_type'] . '</td>';
                echo '<td style="color:blue" align="center";>' . $row['Due'] . '</td>';
				echo '<td style="color:blue" align="center";>' . $row['Deposit_amount'] . '</td>';
				echo '<td style="color:blue" align="center";>' . $row['Total_amnt'] . '</td>';
